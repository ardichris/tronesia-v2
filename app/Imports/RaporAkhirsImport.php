            ...
            if(!is_null($siswa)){
                ...
                if(is_null($cekdata)){
                    RaporAkhir::create([
                        ...
                        'ra_pak_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[17])).'.',
                        'ra_pak_keterampilan_nilai' => $row[18],
                        'ra_pak_keterampilan_predikat' => $row[19],
                        'ra_pak_keterampilan_deskripsi' => ucfirst(capitalize_after_delimiters($row[20])).'.',
                        'ra_pkn_pengetahuan_nilai' => $row[21],
                        'ra_pkn_pengetahuan_predikat' => $row[22],
                        'ra_pkn_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[23])).'.',
                        'ra_pkn_keterampilan_nilai' => $row[24],
                        'ra_pkn_keterampilan_predikat' => $row[25],
                        'ra_pkn_keterampilan_deskripsi' => ucfirst(capitalize_after_delimiters($row[26])).'.',
                        'ra_bin_pengetahuan_nilai' => $row[27],
                        'ra_bin_pengetahuan_predikat' => $row[28],
                        'ra_bin_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[29])).'.',
                        'ra_bin_keterampilan_nilai' => $row[30],
                        'ra_bin_keterampilan_predikat' => $row[31],
                        'ra_bin_keterampilan_deskripsi' => ucfirst(capitalize_after_delimiters($row[32])).'.',
                        'ra_mat_pengetahuan_nilai' => $row[33],
                        'ra_mat_pengetahuan_predikat' => $row[34],
                        'ra_mat_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[35])).'.',
                        'ra_mat_keterampilan_nilai' => $row[36],
                        'ra_mat_keterampilan_predikat' => $row[37],
                        'ra_mat_keterampilan_deskripsi' => ucfirst(capitalize_after_delimiters($row[38])).'.',
                        'ra_ipa_pengetahuan_nilai' => $row[39],
                        'ra_ipa_pengetahuan_predikat' => $row[40],
                        'ra_ipa_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[41])).'.',
                        'ra_ipa_keterampilan_nilai' => $row[42],
                        'ra_ipa_keterampilan_predikat' => $row[43],
                        'ra_ipa_keterampilan_deskripsi' => ucfirst(capitalize_after_delimiters($row[44])).'.',
                        'ra_ips_pengetahuan_nilai' => $row[45],
                        'ra_ips_pengetahuan_predikat' => $row[46],
                        'ra_ips_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[47])).'.',
                        'ra_ips_keterampilan_nilai' => $row[48],
                        'ra_ips_keterampilan_predikat' => $row[49],
                        'ra_ips_keterampilan_deskripsi' => ucfirst(capitalize_after_delimiters($row[50])).'.',
                        'ra_big_pengetahuan_nilai' => $row[51],
                        'ra_big_pengetahuan_predikat' => $row[52],
                        'ra_big_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[53])).'.',
                        'ra_big_keterampilan_nilai' => $row[54],
                        'ra_big_keterampilan_predikat' => $row[55],
                        'ra_big_keterampilan_deskripsi' => ucfirst(capitalize_after_delimiters($row[56])).'.',
                        'ra_bdy_pengetahuan_nilai' => $row[57],
                        'ra_bdy_pengetahuan_predikat' => $row[58],
                        'ra_bdy_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[59])).'.',
                        'ra_bdy_keterampilan_nilai' => $row[60],
                        'ra_bdy_keterampilan_predikat' => $row[61],
                        'ra_bdy_keterampilan_deskripsi' => ucfirst(capitalize_after_delimiters($row[62])).'.',
                        'ra_org_pengetahuan_nilai' => $row[63],
                        'ra_org_pengetahuan_predikat' => $row[64],
                        'ra_org_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[65])).'.',
                        'ra_org_keterampilan_nilai' => $row[66],
                        'ra_org_keterampilan_predikat' => $row[67],
                        'ra_org_keterampilan_deskripsi' => ucfirst(capitalize_after_delimiters($row[68])).'.',
                        'ra_pky_pengetahuan_nilai' => $row[69],
                        'ra_pky_pengetahuan_predikat' => $row[70],
                        'ra_pky_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[71])).'.',
                        'ra_pky_keterampilan_nilai' => $row[72],
                        'ra_pky_keterampilan_predikat' => $row[73],
                        'ra_pky_keterampilan_deskripsi' => ucfirst(capitalize_after_delimiters($row[74])).'.',
                        'ra_jwa_pengetahuan_nilai' => $row[75],
                        'ra_jwa_pengetahuan_predikat' => $row[76],
                        'ra_jwa_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[77])).'.',
                        'ra_jwa_keterampilan_nilai' => $row[78],
                        'ra_jwa_keterampilan_predikat' => $row[79],
                        'ra_jwa_keterampilan_deskripsi' => ucfirst(capitalize_after_delimiters($row[80])).'.',
                        'ra_man_pengetahuan_nilai' => $row[81],
                        'ra_man_pengetahuan_predikat' => $row[82],
                        'ra_man_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[83])).'.',
                        'ra_man_keterampilan_nilai' => $row[84],
                        'ra_man_keterampilan_predikat' => $row[85],
                        'ra_man_keterampilan_deskripsi' => ucfirst(capitalize_after_delimiters($row[86])).'.',
