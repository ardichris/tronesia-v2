            ...
            if(!is_null($siswa)){
                ...
                if(is_null($cekdata)){
                    RaporAkhir::create([
                        ...
                        'ra_pak_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[41])).'.',
                        'ra_pkn_pengetahuan_nilai' => $row[45],
                        'ra_pkn_pengetahuan_predikat' => $row[46],
                        'ra_pkn_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[47])).'.',
                        'ra_bin_pengetahuan_nilai' => $row[15],
                        'ra_bin_pengetahuan_predikat' => $row[16],
                        'ra_bin_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[17])).'.',
                        'ra_mat_pengetahuan_nilai' => $row[36],
                        'ra_mat_pengetahuan_predikat' => $row[37],
                        'ra_mat_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[38])).'.',
                        'ra_ipa_pengetahuan_nilai' => $row[30],
                        'ra_ipa_pengetahuan_predikat' => $row[31],
                        'ra_ipa_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[32])).'.',
                        'ra_ips_pengetahuan_nilai' => $row[33],
                        'ra_ips_pengetahuan_predikat' => $row[34],
                        'ra_ips_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[35])).'.',
                        'ra_big_pengetahuan_nilai' => $row[18],
                        'ra_big_pengetahuan_predikat' => $row[19],
                        'ra_big_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[20])).'.',
                        'ra_bdy_pengetahuan_nilai' => $row[51],
                        'ra_bdy_pengetahuan_predikat' => $row[52],
                        'ra_bdy_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[53])).'.',
                        'ra_org_pengetahuan_nilai' => $row[42],
                        'ra_org_pengetahuan_predikat' => $row[43],
                        'ra_org_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[44])).'.',
                        'ra_pky_pengetahuan_nilai' => $row[48],
                        'ra_pky_pengetahuan_predikat' => $row[49],
                        'ra_pky_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[50])).'.',
                        'ra_jwa_pengetahuan_nilai' => $row[21],
                        'ra_jwa_pengetahuan_predikat' => $row[22],
                        'ra_jwa_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[23])).'.',
                        'ra_man_pengetahuan_nilai' => $row[24],
                        'ra_man_pengetahuan_predikat' => $row[25],
                        'ra_man_pengetahuan_deskripsi' => ucfirst(capitalize_after_delimiters($row[26])).'.',
                        'ra_ekstra1_kegiatan' => $row[105],
