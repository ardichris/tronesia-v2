...
const mutations = {
    ...
    ASSIGN_FORM(state, payload) {
        state.siswa = {
            ...
            s_wali_alamat: payload.s_wali_alamat,
            s_wali_notelp: payload.s_wali_notelp,
            ...
            s_domisili_alamat: payload.s_domisili_alamat,
            ...
            kelas: payload.kelas,
            s_nama_panggilan: payload.s_nama_panggilan,
            s_golongan_darah: payload.s_golongan_darah,
            s_warga_negara: payload.s_warga_negara,
            s_saudara_kandung: payload.s_saudara_kandung,
            s_saudara_tiri: payload.s_saudara_tiri,
            s_saudara_angkat: payload.s_saudara_angkat,
            s_status_anak: payload.s_status_anak,
            s_bahasa: payload.s_bahasa,
            s_ibu_tempat_lahir: payload.s_ibu_tempat_lahir,
            s_ibu_agama: payload.s_ibu_agama,
            s_ibu_warga_negara: payload.s_ibu_warga_negara,
            s_ayah_tempat_lahir: payload.s_ayah_tempat_lahir,
            s_ayah_agama: payload.s_ayah_agama,
            s_ayah_warga_negara: payload.s_ayah_warga_negara,
            s_pengeluaran: payload.s_pengeluaran,
        }
    },
    CLEAR_FORM(state) {
        state.siswa = {
