...
Route::group(['middleware' => 'auth:api'], function() {
    ...
    Route::get('/laporan/kurikulum/nilai','API\LaporanController@nilai');
    ...
    Route::get('downloadnilaikurmer', 'API\NilaiSiswaController@downloadNilaiKurmer');
    Route::get('downloadnilaipengetahuan', 'API\NilaiSiswaController@downloadNilaiPengetahuan');
    Route::get('downloadnilaiketerampilan', 'API\NilaiSiswaController@downloadNilaiKeterampilan');
